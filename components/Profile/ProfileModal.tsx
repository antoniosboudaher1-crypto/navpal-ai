...
import { X, Trophy, Map, Shield, LogOut, User as UserIcon, ChevronRight, Volume2, VolumeX, History, Edit2, Check, ChevronLeft, Lock, FileText, Download, Trash2, Info } from 'lucide-react';
